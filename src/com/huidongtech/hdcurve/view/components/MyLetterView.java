...
import com.huidongtech.hdcurve.util.PixelUtil;
...
public class MyLetterView extends View {
	...
	public static final String[] letter1={"#","A", "B", "C", "D", "E", "F", "G", "H", "I",
		"J", "K", "L", "M"};
	public static final String[] letter2={"N", "O", "P", "Q", "R", "S", "T", "U", "V",
		"W", "X", "Y", "Z"};
	...
	public void setLetterSource(String[] source){
		b=source;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		int halfsingleHeight=singleHeight/2;
		for (int i = 0; i < b.length; i++) {
			...
			// 选中的状态
			if (i == choose) {
				paint.setColor(getResources().getColor(R.color.whitebtnpress));
				paint.setFakeBoldText(true);
			}
			// x坐标等于中间-字符串宽度的一半.
			float xPos = width / 2 - paint.measureText(b[i]) / 2;
			float yPos = singleHeight * i + halfsingleHeight;
